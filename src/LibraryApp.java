...
/**
 * Main application class for Library Management System (MySQL Database Edition). This class
 * provides the command-line interface to interact with the library, including adding, removing,
 * updating, borrowing, and returning documents, as well as managing users.
 */
public class LibraryApp {
   ...
   *
   * @param choice integer representing the menu option selected by the user
   */
  ...
  /**
   * Reads and validates the user's menu choice. Ensures the choice is a single digit between 0 and
   * 9.
   *
  ...
  /**
   * Manages document operations through a sub-menu.
   *
   * @param scanner Scanner object for reading user input
   * @param documentDAO DAO object for document database operations
   */
  ...
  /**
   * Manages user operations through a sub-menu.
   *
   * @param scanner Scanner object for reading user input
   * @param userDAO DAO object for user database operations
   */
